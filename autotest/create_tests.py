...
_exclude_nb_list = [
    ...
    '01_read_write_text_files.ipynb',
    '02_strings_exercise.ipynb',
    '03_lists_exercise.ipynb',
    '04_dictionaries_exercise.ipynb',
    '01_recap1_exercise.ipynb',
...
def create_test_modules(nbdir, name):
    """
    Create python script test_{name}.py with test functions.

    These are created for all notebooks that are in the nbdir and
    not in the _exclude_nb_list
